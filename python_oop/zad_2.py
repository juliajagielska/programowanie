...
class Order:
    def __init__(self, employee: Employee, student: Student,
                 books: List[Book], order_date: str) -> None:
...
if __name__ == "__main__":
    ...
    employee1 = Employee("Anna", "Nowak", "2020-01-05", "1990-06-10",
                         "Warszawa", "Marszałkowska 1", "00-001", "111-222-333")
    employee2 = Employee("Jan","Kowalski", "2019-03-10", "1985-02-20",
                         "Kraków", "Długa 5", "31-001", "444-555-666")
    employee3 = Employee("Ewa", "Wiśniewska", "2022-09-01", "1995-11-30",
                         "Warszawa", "Marszałkowska 1", "00-001", "777-888-999")
